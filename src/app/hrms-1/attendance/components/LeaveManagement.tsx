...
import {
  ...
  TableHeader,
  TableRow,
} from '@/components/hrms-1/ui/table';
import {
  Dialog,
  DialogContent,
  DialogDescription,
    ...
    <div className="space-y-6">
      ...
      <Card className="transition-all duration-300 hover:shadow-lg">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="relative overflow-hidden p-5 rounded-xl bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 shadow-lg border border-blue-400/30 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl group">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="font-semibold text-white text-lg">0-6 Months</span>
                </div>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between items-center bg-white/10 backdrop-blur-sm px-3 py-2 rounded-lg">
                    <span className="text-white/90">Casual Leave:</span>
                    <span className="font-bold text-white">{tenurePolicy['0-6months'].casualLeave} days</span>
                  </div>
                  <div className="flex justify-between items-center bg-white/10 backdrop-blur-sm px-3 py-2 rounded-lg">
                    <span className="text-white/90">Sick Leave:</span>
                    <span className="font-bold text-white">{tenurePolicy['0-6months'].sickLeave} days</span>
                  </div>
                  <div className="flex justify-between items-center bg-white/10 backdrop-blur-sm px-3 py-2 rounded-lg">
                    <span className="text-white/90">Earned Leave:</span>
                    <span className="font-bold text-white">{tenurePolicy['0-6months'].earnedLeave} days</span>
                  </div>
                  <div className="flex justify-between items-center bg-white/10 backdrop-blur-sm px-3 py-2 rounded-lg">
                    <span className="text-white/90">Compensatory Off:</span>
                    <span className="font-bold text-white">{tenurePolicy['0-6months'].compOff} days</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="relative overflow-hidden p-5 rounded-xl bg-gradient-to-br from-emerald-500 via-green-600 to-emerald-700 shadow-lg border border-emerald-400/30 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl group">
              <div className="absolute inset-0 bg-gradient-to-t from-black/10 via-transparent to-transparent" />
              <div className="absolute top-0 right-0 w-24 h-24 bg-white/10 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2" />
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="font-semibold text-white text-lg">6-12 Months</span>
                </div>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between items-center bg-white/10 backdrop-blur-sm px-3 py-2 rounded-lg">
                    <span className="text-white/90">Casual Leave:</span>
                    <span className="font-bold text-white">{tenurePolicy['6-12months'].casualLeave} days</span>
                  </div>
                  <div className="flex justify-between items-center bg-white/10 backdrop-blur-sm px-3 py-2 rounded-lg">
                    <span className="text-white/90">Sick Leave:</span>
                    <span className="font-bold text-white">{tenurePolicy['6-12months'].sickLeave} days</span>
                  </div>
                  <div className="flex justify-between items-center bg-white/10 backdrop-blur-sm px-3 py-2 rounded-lg">
                    <span className="text-white/90">Earned Leave:</span>
                    <span className="font-bold text-white">{tenurePolicy['6-12months'].earnedLeave} days</span>
                  </div>
                  <div className="flex justify-between items-center bg-white/10 backdrop-blur-sm px-3 py-2 rounded-lg">
                    <span className="text-white/90">Compensatory Off:</span>
                    <span className="font-bold text-white">{tenurePolicy['6-12months'].compOff} days</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="relative overflow-hidden p-5 rounded-xl bg-gradient-to-br from-purple-500 via-violet-600 to-purple-700 shadow-lg border border-purple-400/30 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl group">
              <div className="absolute inset-0 bg-gradient-to-t from-black/10 via-transparent to-transparent" />
              <div className="absolute top-0 right-0 w-24 h-24 bg-white/10 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2" />
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="font-semibold text-white text-lg">1 Year+</span>
                </div>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between items-center bg-white/10 backdrop-blur-sm px-3 py-2 rounded-lg">
                    <span className="text-white/90">Casual Leave:</span>
                    <span className="font-bold text-white">{tenurePolicy['1year+'].casualLeave} days</span>
                  </div>
                  <div className="flex justify-between items-center bg-white/10 backdrop-blur-sm px-3 py-2 rounded-lg">
                    <span className="text-white/90">Sick Leave:</span>
                    <span className="font-bold text-white">{tenurePolicy['1year+'].sickLeave} days</span>
                  </div>
                  <div className="flex justify-between items-center bg-white/10 backdrop-blur-sm px-3 py-2 rounded-lg">
                    <span className="text-white/90">Earned Leave:</span>
                    <span className="font-bold text-white">{tenurePolicy['1year+'].earnedLeave} days</span>
                  </div>
                  <div className="flex justify-between items-center bg-white/10 backdrop-blur-sm px-3 py-2 rounded-lg">
                    <span className="text-white/90">Compensatory Off:</span>
                    <span className="font-bold text-white">{tenurePolicy['1year+'].compOff} days</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <Card className="transition-all duration-300 hover:shadow-lg">
        ...
        <CardContent>
          {/* Filters */}
          {viewMode === 'requests' && (
            <div className="mb-4 flex flex-wrap gap-4 p-4 bg-gradient-to-r from-gray-50 to-gray-100/50 rounded-lg border border-gray-200/50 backdrop-blur-sm">
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                <SelectTrigger className="w-[180px] bg-white/80 backdrop-blur-sm border-gray-300 hover:bg-white transition-all duration-200 hover:shadow-md">
              ...
              <div className="relative flex-1 max-w-[300px]">
                ...
                <Input
                  ...
                  className="pl-10 bg-white/80 backdrop-blur-sm border-gray-300 hover:bg-white transition-all duration-200 hover:shadow-md focus:shadow-md"
                />
              </div>
            </div>
          )}
              ...
              <TableHeader>
                {viewMode === 'balance' ? (
                  <TableRow className="bg-gradient-to-r from-gray-50 to-gray-100/50">
                    ...
                    <TableHead className="font-semibold">Earned Leave</TableHead>
                    <TableHead className="font-semibold">Comp Off</TableHead>
                    <TableHead className="font-semibold">LOP</TableHead>
                  </TableRow>
                ) : (
                  <TableRow className="bg-gradient-to-r from-gray-50 to-gray-100/50">
                    <TableHead className="cursor-pointer hover:bg-gray-200/50 transition-colors duration-200 font-semibold" onClick={() => handleSort('employeeName')}>
                    ...
                    <TableHead className="cursor-pointer hover:bg-gray-200/50 transition-colors duration-200 font-semibold" onClick={() => handleSort('leaveType')}>
                      <div className="flex items-center gap-2">
                        Leave Type
                    ...
                    <TableHead className="cursor-pointer hover:bg-gray-200/50 transition-colors duration-200 font-semibold" onClick={() => handleSort('from')}>
                      <div className="flex items-center gap-2">
                        From
                        {sortConfig?.key === 'from' && (
                          <ArrowUpDown className="h-4 w-4" />
                    ...
                    <TableHead className="cursor-pointer hover:bg-gray-200/50 transition-colors duration-200 font-semibold" onClick={() => handleSort('to')}>
                      <div className="flex items-center gap-2">
                        To
                        {sortConfig?.key === 'to' && (
                          <ArrowUpDown className="h-4 w-4" />
                    ...
                    <TableHead className="cursor-pointer hover:bg-gray-200/50 transition-colors duration-200 font-semibold" onClick={() => handleSort('status')}>
                      <div className="flex items-center gap-2">
                        Status
                ...
                {viewMode === 'balance' ? (
                  ...
                  leaveBalanceData.slice(0, 10).map((employee) => (
                    <TableRow 
                      ...
                      className="transition-all duration-200 hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-indigo-50/50 hover:shadow-sm cursor-pointer"
                    >
                      <TableCell className="font-medium">{employee.employeeCode}</TableCell>
                      <TableCell>{employee.employeeName}</TableCell>
                      <TableCell>
                        <Badge className="bg-blue-100 text-blue-800 hover:bg-blue-200 transition-colors">{employee.casualLeave}</Badge>
                      </TableCell>
                      <TableCell>
                        <Badge className="bg-green-100 text-green-800 hover:bg-green-200 transition-colors">{employee.sickLeave}</Badge>
                      </TableCell>
                      <TableCell>
                        <Badge className="bg-purple-100 text-purple-800 hover:bg-purple-200 transition-colors">{employee.earnedLeave}</Badge>
                      </TableCell>
                      <TableCell>
                        <Badge className="bg-cyan-100 text-cyan-800 hover:bg-cyan-200 transition-colors">{employee.compOff}</Badge>
                      </TableCell>
                      <TableCell>
                        <Badge className="bg-red-100 text-red-800 hover:bg-red-200 transition-colors">{employee.lop}</Badge>
                      </TableCell>
                    </TableRow>
                  ))
                ) : (
                  ...
                  filteredAndSortedData.slice(0, 10).map((item) => (
                    <TableRow 
                      key={item.id}
                      className="transition-all duration-200 hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-indigo-50/50 hover:shadow-sm"
                    >
                      ...
                      <TableCell>
                        <Badge className={`${getStatusColor(item.status)} transition-all duration-200 hover:scale-105`}>{item.status}</Badge>
                      </TableCell>
                      <TableCell>

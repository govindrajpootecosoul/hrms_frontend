...
import { Card, CardContent, CardHeader, CardTitle } from '@/components/hrms-1/ui/card';
...
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/components/hrms-1/ui/table';
import { Badge } from '@/components/hrms-1/ui/badge';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/hrms-1/ui/tabs';
...
export default function ExpensesAdvancesPage() {
  ...
  useEffect(() => {
    const fetchExpenses = async () => {
      try {
        const api = (await import('@/lib/hrms-1/api')).default;

...
const navLinks = [
  ...
  { name: 'Requests', href: '/employee-portal/requests' },
  { name: 'My Organisation', href: '/employee-portal/my-organisation' },
  { name: 'Reports', href: '/employee-portal/reports' },
];
        ...
        <div className="relative mx-auto flex w-full max-w-[1600px] flex-col gap-6 px-4 py-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:gap-6">
            <div className="order-2 lg:order-1">
              ...
              <div className="mt-3 flex flex-wrap gap-2 text-xs font-medium">
                <span className="rounded-full bg-white/15 px-3 py-1">
                  Employee ID: {user?.employeeId ?? user?.id ?? '—'}
                </span>
            ...
            <div className="order-1 lg:order-2 flex justify-center">
              <div className="rounded-full border border-white/20 bg-white/10 p-3 backdrop-blur overflow-hidden">
                <Image
                  src={user?.avatar || "/employee_select_portal.png"}
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 text-sm">
              ...
              <span>{user?.name ?? 'Employee User'}</span>
            </div>
            <Button
              variant="secondary"
              size="sm"

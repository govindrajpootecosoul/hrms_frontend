...
const Input = forwardRef(({ 
  ...
  const base = 'w-full px-4 py-3 rounded-xl focus:ring-2 transition-all duration-200 border border-neutral-300 bg-white text-neutral-900 placeholder-neutral-400 focus:border-primary-300 focus:ring-primary-200';
  ...
  const inputClasses = `
    ${base} ${errorRing} ${disabledStyles} ${paddingIconLeft} ${paddingIconRight} ${className}
  `.trim();

...
const Layout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/queries', label: 'Queries List', icon: 'list_alt' },
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="relative" ref={userMenuRef}>
                ...
                >
                  <div className="w-10 h-10 rounded-full bg-gradient-to-r from-primary-blue to-primary-blue-light flex items-center justify-center">
                    <span className="text-white text-xs font-semibold">
                      {user?.name?.charAt(0).toUpperCase() || 'U'}
                    </span>
                  </div>
                  {userMenuOpen && (
                    <span className="absolute -bottom-1 -right-1 w-4 h-4 rounded-full bg-primary-blue border-2 border-white flex items-center justify-center">
                ...
                {/* Dropdown Menu */}
                {userMenuOpen && (
                  <div className="absolute right-0 top-full mt-2 w-64 glass-glow rounded-xl border border-white/50 shadow-2xl z-[100] overflow-hidden">

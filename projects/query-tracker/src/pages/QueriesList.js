  ...
  const fetchQueries = async () => {
    try {
      ...
      const params = {
        page: currentPage,
        limit: 10,
        ...(activeTab === 'my' && { createdBy: user._id }),
    ...
    <div className="space-y-6">
      ...
      <div className="glass p-4 rounded-xl grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <select
          ...
          className="border border-gray-200 bg-white/50 p-2 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-gold focus:border-transparent transition-all"
        >
                      ...
                      <td className="p-4">
                        <div className="flex space-x-2">
                          <button
                            ...
                            disabled={!isAdmin() && query.createdBy._id !== user._id}
                            title="Edit"
                          >
